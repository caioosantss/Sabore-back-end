...
public class favoritoController {
    ...
    public ResponseEntity<List<Favorito>> listarFavoritosDoUsuario(@PathVariable Long usuario_id, @PathVariable Long receita_id) {
        List<Favorito> lista = favoritoService.listarFavoritosDoUsuario(usuario_id);
